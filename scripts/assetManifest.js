...
export const assetManifest = [
    ...
    // === Wave 32: Per-template slot rank symbols (J / Q / K / A / 10).
    // Each set is a sprite atlas with five rank symbols themed for the slot.
    // Generated by `node scripts/genAssets.js --filter=slot-rank-`.
    //
    // Wave 33: rewrote prompts to insist on transparent background, no plate,
    // no bezel, no halo. The post-processor (`scripts/stripSlotRankBg.mjs`)
    // also alpha-strips any residual background. Subject-only glyph art.
    { name: 'slot-rank-vault-rush', dir: 'slots/vault', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as bank vault deposit slips with embossed gold rank glyph and tiny bronze rivets. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no card frame, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-river-catcher', dir: 'slots/catcher', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as wooden fishing bobbers with golden trim and brass eyelet, glossy wet finish. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-dust-rail', dir: 'slots/western', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as western sheriff badges, copper finish with leather strap accent and engraved rank glyph. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-storm-banner', dir: 'slots/mythic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as mythic shields with engraved viking rune-style rank, brushed steel and aurora-blue glow. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-bassline-bonus', dir: 'slots/rock', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as backstage passes: glossy laminate cards with neon magenta rank lettering and lanyard ribbon at top. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-scarab-spin', dir: 'slots/mythic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Egyptian sandstone tablets with hieroglyphic-style rank glyphs, gold inlay, weathered edges. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-bars', dir: 'slots/classic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as classic Vegas chrome plaques with cherry-red rank engraving, glossy art-deco finish. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-blue-samurai', dir: 'slots/cyber', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as samurai paper talismans with cobalt-blue brushstroke rank and golden seal corner. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-wanted-revelation', dir: 'slots/wanted', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as old west wanted-poster scraps: weathered tan parchment with woodblock-style rank stamp and torn edges. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-gates-ascent', dir: 'slots/olympus', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Olympian marble plinths with gold-leafed rank glyph and laurel border. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-bass-bayou', dir: 'slots/bayou', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as bayou tackle tags: weathered wood with green moss accents, brass nail trim, and engraved rank. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-mummy-cascade', dir: 'slots/mummy', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Egyptian linen-wrapped tablets with ember-red rank glyph and cracked stone edge. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-phoenix-megaways', dir: 'slots/phoenix', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as phoenix feathers with embers, glossy obsidian shaft and orange flame-edge rank glyph. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-mansion-megaways', dir: 'slots/mansion', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as gothic mansion plaques: deep purple velvet pad with silver filigree and pale violet rank glyph. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-ghostblade-strike', dir: 'slots/ronin', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as ghostblade sword guards (tsuba) with cyan ethereal glow and brushed steel rank glyph. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-iron-fist', dir: 'slots/iron', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as boxing belt buckles, polished chrome with hot-orange rank glyph and leather strap notch. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-coop-cluck', dir: 'slots/coop', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as cute farm wood signs with painted gold rank, hay accents, and rope hanger. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-miko-spirit', dir: 'slots/spirit', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Japanese paper lanterns with rose-pink rank glyph painted on washi paper and tassel below. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-forge-anvil', dir: 'slots/forge', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as molten anvil-stamped rank glyphs glowing red-hot on iron plate, sparks falling. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
    { name: 'slot-rank-gummy-drops', dir: 'slots/gummy', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as candy-coated jellies in pink/blue/yellow with glossy sprinkles and rank glyph as candy emboss. Subject-only PNG with FULLY TRANSPARENT background, no plate, no bezel, no halo, no shadow. The artwork must occupy roughly the central 35-50% of each tile; corners and outer rim must be 100% transparent (alpha = 0). Five tiles arranged horizontally with transparent gaps between them. ${STYLE}` },
]
