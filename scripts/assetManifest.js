...
export const assetManifest = [
    ...
    { name: 'slot-rank-vault-rush', dir: 'slots/vault', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as bank-vault deposit slips: bronze bezel, navy felt face, embossed gold rank glyph, evenly spaced, transparent gaps, no extra text. ${STYLE}` },
    { name: 'slot-rank-river-catcher', dir: 'slots/catcher', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as fishing tackle: wooden bobbers shaped like card ranks, glossy wet finish, golden trim, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-dust-rail', dir: 'slots/western', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as western sheriff badges with engraved rank, copper finish, leather strap accents, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-storm-banner', dir: 'slots/mythic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as mythic shields with engraved viking rune-style rank, brushed steel and aurora-blue glow, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-bassline-bonus', dir: 'slots/rock', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as backstage passes with neon magenta lettering, lanyard ribbon, glossy laminate, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-scarab-spin', dir: 'slots/mythic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Egyptian sandstone tablets with hieroglyphic-style rank glyphs, gold inlay, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-bars', dir: 'slots/classic', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as classic Vegas chrome plaques with cherry-red rank engraving, glossy art-deco finish, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-blue-samurai', dir: 'slots/cyber', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as samurai paper talismans with cobalt-blue brushstroke rank, golden seal corner, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-wanted-revelation', dir: 'slots/wanted', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as old west wanted-poster snippets, weathered tan parchment, woodblock-style rank stamp, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-gates-ascent', dir: 'slots/olympus', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Olympian marble plinths with gold-leafed rank glyph and laurel border, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-bass-bayou', dir: 'slots/bayou', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as bayou tackle tags: weathered wood with green moss accents and brass nail trim, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-mummy-cascade', dir: 'slots/mummy', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Egyptian linen-wrapped tablets with ember-red rank glyph and cracked stone edge, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-phoenix-megaways', dir: 'slots/phoenix', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as phoenix feathers with embers, glossy obsidian shaft and orange flame-edge rank, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-mansion-megaways', dir: 'slots/mansion', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as gothic mansion plaques: deep purple velvet with silver filigree and pale violet rank glyph, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-ghostblade-strike', dir: 'slots/ronin', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as ghostblade sword guards (tsuba) with cyan ethereal glow, brushed steel rank glyph, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-iron-fist', dir: 'slots/iron', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as boxing belt buckles, polished chrome, hot-orange rank glyph, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-coop-cluck', dir: 'slots/coop', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as cute farm wood signs with painted gold rank, hay accents, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-miko-spirit', dir: 'slots/spirit', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as Japanese paper lanterns with rose-pink rank glyph and tassel, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-forge-anvil', dir: 'slots/forge', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as molten anvil-stamped rank glyphs on red-hot iron plate, evenly spaced, no extra text. ${STYLE}` },
    { name: 'slot-rank-gummy-drops', dir: 'slots/gummy', size: wide, prompt: `Five vertical card-rank symbols (10, J, Q, K, A) themed as candy-coated jellies in pink/blue/yellow with glossy sprinkles, rank glyph as candy emboss, evenly spaced, no extra text. ${STYLE}` },
]
