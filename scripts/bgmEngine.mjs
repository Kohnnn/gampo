...
export const ARCHETYPES = {
    ...
    'case-tension': {
        ...
        beatsPerLoop: 16,
        melody: [
            'C4', 'D#4', 'G4', 'C5', 'D#5', 'C5', 'G4', 'D#4',
            'C4', 'F4', 'G#4', 'C5', 'F5', 'D#5', 'C5', 'G#4',
        ],
        bass: ['C2', 'C2', 'G2', 'G2', 'D#2', 'D#2', 'A#2', 'A#2'],
        chords: null,
        chordQualities: ['min', 'min', 'maj', 'dom7'],
        melodyVoice: (t, f, phase) => osc(t, f, 'pulse12') * (phase < 0.08 ? phase / 0.08 : Math.exp(-(phase - 0.08) * 4.2)) * 0.42,
        bassVoice: (t, f, phase) => (osc(t, f, 'sine') + osc(t, f * 0.5, 'sine') * 0.45) * bassEnv(phase) * 0.72,
        drumPattern: '1011101010111010',
        kickPattern: '1000101010001010',
        snarePattern: '0000100000001000',
    },
    'tarot-arcana': {
        bpm: 78,
        ...
        melody: [
            ...
            'D5', 'F5', 'A5', 'C6', 'B5', 'G5', 'E5', 'C5',
        ],
        bass: ['A2', 'A2', 'E2', 'E2', 'F2', 'F2', 'G2', 'G2'],
        chords: ['Am', 'Am', 'Em', 'Em', 'F', 'F', 'G', 'G'],
        chordQualities: ['min7', 'min7', 'min', 'min', 'maj7', 'maj7', 'sus4', 'sus2'],
        melodyVoice: (t, f, phase) => (detunedSaws(t, f, 5, 0.01) * 0.7 + osc(t, f * 2, 'sine') * 0.2) * padEnv(phase) * 0.34,
        bassVoice: (t, f, phase) => osc(t, f, 'triangle') * bassEnv(phase) * 0.42,
        drumPattern: '0000000000000000',
        kickPattern: '1000000000000000',
        snarePattern: '0000000000000000',
    },
}
