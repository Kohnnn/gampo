...
const navItems = [
    { icon: 'chart', label: 'Lobby', path: '/' },
    { icon: 'original', label: 'Originals', path: '/originals' },
    { icon: 'slot', label: 'Slots Lobby', path: '/slots-lobby' },
    { icon: 'live', label: 'Live Studio', path: '/live' },
    { icon: 'trophy', label: 'Sportsbook', path: '/sports' },
    { icon: 'gift', label: 'Promotions', path: '/promotions' },
    { icon: 'gift', label: 'Missions', path: '/missions' },
    { icon: 'cards', label: 'VIP Lab', path: '/vip' },
    { icon: 'new', label: 'Risk Academy', path: '/learn' },
    { icon: 'check', label: 'Verify', path: '/verify' },
    { icon: 'trophy', label: 'Race', path: '/race' },
...
const gameItems = [
    ...
    { icon: 'gamepad', label: 'Dice', path: '/dice' },
    { icon: 'burst', label: 'Limbo', path: '/limbo' },
    { icon: 'circle', label: 'Keno', path: '/keno' },
    { icon: 'roulette', label: 'Wheel', path: '/wheel' },
    { icon: 'roulette', label: 'Roulette', path: '/roulette' },
    { icon: 'cards', label: 'Blackjack', path: '/blackjack' },
    { icon: 'cards', label: 'Baccarat', path: '/baccarat' },
    { icon: 'cards', label: 'Casino War', path: '/war' },
    { icon: 'gamepad', label: 'Sic Bo', path: '/sicbo' },
    { icon: 'cards', label: 'Video Poker', path: '/videopoker' },
    { icon: 'circle', label: 'Color Pick', path: '/color' },
    { icon: 'star', label: 'Tower', path: '/tower' },
    { icon: 'dino', label: 'Chicken Cross', path: '/chickencross' },
    { icon: 'gift', label: 'Lottery', path: '/lottery' },
    { icon: 'slot', label: 'Slots', path: '/slots' },
    { icon: 'circle', label: 'Coin Flip', path: '/coinflip' },
    { icon: 'burst', label: 'RPS', path: '/rps' },
    { icon: 'new', label: 'Guess Number', path: '/guess' },
    { icon: 'cards', label: 'Hi-Lo Cards', path: '/hilo' },
    { icon: 'cards', label: 'Live Poker', path: '/poker' },
]
        ...
        <aside className={`app-sidebar ${!isOpen ? 'app-sidebar-hidden' : ''}`}>
            ...
            <nav className="sidebar-nav">
                <div className="nav-section">
                    <h3 className="nav-title">Casino</h3>
                    {navItems.map((item) => (
                        <NavLink
                            key={item.path}
                            to={item.path}
