...
describe('packs is pinned to the component', () => {
    it('rounds the return and the profit', () => {
        expect(source).toContain("const returnAmount = round2(stake * totalMult)")
        expect(source).toContain("const profit = round2(returnAmount - stake)")
    })
...
describe('packs component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./PacksGame.jsx')
