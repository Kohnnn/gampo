...
describe('tarot is pinned to the component', () => {
    it('rounds the return and the profit', () => {
        expect(source).toContain("const returnAmount = round2(betAmount * totalMult)")
...
describe('tarot component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./TarotGame.jsx')
