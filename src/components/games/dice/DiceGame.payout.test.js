...
const source = readFileSync(new URL('./DiceGame.jsx', import.meta.url), 'utf8')
...
const MULTIPLIERS = [1.96,1.306,0.9796,3.92,9.8,19.6,1.0315789473684212]
const STAKES = [1, 2, 3, 5, 7, 10, 25, 100, 137]
const TWO_DP = /^-?\d+(\.\d{1,2})?$/

describe('dice payout rounding', () => {
...
describe('dice is pinned to the component', () => {
...
describe('dice component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./DiceGame.jsx')
