...
const source = readFileSync(new URL('./SlideGame.jsx', import.meta.url), 'utf8')
...
const MULTIPLIERS = [1.0105263157894737,1.2,1.6,1.92,2.4,3.2,4.8,9.6,19.2]
const STAKES = [1, 2, 3, 5, 7, 10, 25, 100, 137]
const TWO_DP = /^-?\d+(\.\d{1,2})?$/

describe('slide payout rounding', () => {
...
describe('slide is pinned to the component', () => {
...
describe('slide component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./SlideGame.jsx')
