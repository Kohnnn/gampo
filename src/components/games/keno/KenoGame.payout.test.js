...
const source = readFileSync(new URL('./KenoGame.jsx', import.meta.url), 'utf8')
...
const MULTIPLIERS = [0,0.5,1.1,1.6,2.4,4.8,9.6,26.4]
const STAKES = [1, 2, 3, 5, 7, 10, 25, 100, 137]
const TWO_DP = /^-?\d+(\.\d{1,2})?$/

describe('keno payout rounding', () => {
...
describe('keno is pinned to the component', () => {
...
describe('keno component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./KenoGame.jsx')
