...
describe('limbo is pinned to the component', () => {
    it('rounds the return and the profit', () => {
        expect(source).toContain("const returnAmount = won ? round2(betAmount * target) : 0")
...
describe('limbo component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./LimboGame.jsx')
