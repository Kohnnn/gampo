...
const source = readFileSync(new URL('./MolesGame.jsx', import.meta.url), 'utf8')
...
const MULTIPLIERS = [0,1.92,2.4,3.84,4.8,9.6]
const STAKES = [1, 2, 3, 5, 7, 10, 25, 100, 137]
const TWO_DP = /^-?\d+(\.\d{1,2})?$/

describe('moles payout rounding', () => {
...
describe('moles is pinned to the component', () => {
...
describe('moles component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./MolesGame.jsx')
