...
const source = readFileSync(new URL('./FlipGame.jsx', import.meta.url), 'utf8')

// Mirror of the component's settle math.
function settle({ won, betAmount, PAYOUT }) {
...
describe('flip is pinned to the component', () => {
...
describe('flip component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./FlipGame.jsx')
