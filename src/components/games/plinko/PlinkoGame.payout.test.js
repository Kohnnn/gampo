...
describe('plinko is pinned to the component', () => {
    it('rounds the return and the profit', () => {
        expect(source).toContain("const returnAmount = round2(betAmount * mult)")
        expect(source).toContain("const profit = round2(returnAmount - cost)")
    })
...
describe('plinko component parses', () => {
    ...
    it('imports without a syntax or module-resolution error', async () => {
        const mod = await import('./PlinkoGame.jsx')
