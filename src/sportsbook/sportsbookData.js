...
export const SPORTS = [
    ...
    { id: 'handball', label: 'Handball', icon: CircleDot, sortOrder: 66, groups: ['all-sports'], liveCount: 0 },
    { id: 'rugby', label: 'Rugby', icon: Dumbbell, sortOrder: 67, groups: ['all-sports'], liveCount: 0 },
    { id: 'volleyball', label: 'Volleyball', icon: CircleDot, sortOrder: 68, groups: ['all-sports'], liveCount: 0 },
    { id: 'formula-1', label: 'Formula 1', icon: Flame, sortOrder: 69, groups: ['all-racing'], liveCount: 0 },
    { id: 'mma', label: 'MMA', icon: ShieldCheck, sortOrder: 69.5, groups: ['all-sports'], liveCount: 0 },
...
const MARKET_TEMPLATES = {
    soccer: ['Winner', 'Total Goals', 'Handicap', 'Both Teams To Score', 'Double Chance', 'Draw No Bet', 'Clean Sheet', 'Win to Nil', 'Home Total Goals', 'Away Total Goals', 'Result & Both Teams To Score', 'Correct Score', 'Odd/Even'],
...
function buildSecondaryGroup(eventId, sportId, groupLabel, random, index) {
    ...
    const labelsByMarket = {
        ...
        'Home Total Goals': ['Home Over 1.5', 'Home Under 1.5'],
        'Away Total Goals': ['Away Over 1.5', 'Away Under 1.5'],
        'Result & Both Teams To Score': ['Home & Yes', 'Home & No', 'Draw & Yes', 'Draw & No', 'Away & Yes', 'Away & No'],
        'Odd/Even': ['Odd', 'Even'],
